 ...
 */
public class MainCorrectedNaiveBayes {
...
//                System.out.println("bingo");
        ...
        for(int i = 0; i < totalCount; i++){ // leaving one out at each iteration
            ...
            int q = 4; // Maximum number of clusters
            ...
            double testWeight = (double) weightList.get(testCase);
            int testGender = (int) genderList.get(testCase);
            int testInheritance = (int) inheritanceList.get(testCase);
...
q = 4
    Total test case: 188
        Correct assumptions: 125
        Error: 0.2805269346878097
